...
/**
 * Connection pool for the auth service.
 *
 ...
 * - application_name is set automatically so connections show up as `langphy-auth`
...
pgPool.on("connect", () => {
    console.log("✅ Connected to PostgreSQL (auth)");
});
